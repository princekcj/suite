                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="purchase_code" name="purchase_code" class="form-control" placeholder="088abxxx-2831-47e7-xxxx-9d8dd3c7xxx8"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="form-check-label" >I agree to receive important emails related to the new updates, and security updates. I also consent to receiving promotional emails, including offers, discounts, and updates about new features or services</small>
                            </div>
                        </div>
                    </div>
                </div>
